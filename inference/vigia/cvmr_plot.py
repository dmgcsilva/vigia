...
def inference():
    ...
    with torch.inference_mode():
        ...
        start_sim_matrixes, end_sim_matrixes, r_at_k_iou_at_m_w_sim = calculate_R_at_k_IoU_at_m_with_sim(ret_embs_preds, target_ids, target_embs, sim=0.35, k=1, m=0.5, return_sim_matrix=True)
        ...
        try:
            print(f"Shape of start_sim_matrixes[0]: {start_sim_matrixes[0].shape}, Shape of end_sim_matrixes[0]: {end_sim_matrixes[0].shape}")
        except Exception as e:
            print(f"Length of start_sim_matrixes[0]: {len(start_sim_matrixes[0])}, Length of end_sim_matrixes[0]: {len(end_sim_matrixes[0])}")
