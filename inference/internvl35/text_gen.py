...
def get_args():
    ...
    parser.add_argument("--model", type=str, default="OpenGVLab/InternVL3_5-8B-HF", help="Model name or path")
...
def inference():
    ...
    with torch.inference_mode():
        ...
        model = AutoModelForImageTextToText.from_pretrained(args.model, torch_dtype=torch.float16, trust_remote_code=True)
