...
from transformers import AutoTokenizer, AutoFeatureExtractor, AutoProcessor, Qwen3VLForConditionalGeneration
...
def get_args():
    ...
    parser.add_argument("--ckpt-path", type=str, default="/home/dmgcsilva/project/DATA/hub/models--Qwen--Qwen3-VL-8B-Instruct/snapshots/0c351dd01ed87e9c1b53cbc748cba10e6187ff3b/", help="Path to the checkpoint file")
...
def load_model_and_tokenizer(args):
    ...
    model = Qwen3VLForConditionalGeneration.from_pretrained(args.ckpt_path, torch_dtype=torch.float16)
...
if __name__ == "__main__":
    ...
    out_path = "/home/dmgcsilva/workbench/followup/code/inference/results/qwen3_gen_dialogues.json"
