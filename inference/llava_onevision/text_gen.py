...
def get_args():
    ...
    parser.add_argument("--model", type=str, default="llava-hf/llava-onevision-qwen2-7b-ov-hf", help="Model name or path")
...
def inference():
    ...
    with torch.inference_mode():
        ...
        model = LlavaOnevisionForConditionalGeneration.from_pretrained(args.model, torch_dtype=torch.float16)
